...
from model import ACPred_LAF_Basic, ACPred_LAF_MSE, ACPred_LAF_MSC, ACPred_LAF_MSMC
...
def select_dataset():
    # ACP dataset
    path_train_data = '../data//ACP_dataset/tsv/ACP_mixed_train.tsv'
    path_test_data = '../data/ACP_dataset/tsv/ACP_mixed_test.tsv'
    # path_train_data = '../data/task_data/ACP/tsv/LEE_Dataset.tsv'
    # path_test_data = '../data/task_data/ACP/tsv/Independent dataset.tsv'
    # path_train_data = '../data/task_data/ACP/tsv/ACP2_main_train.tsv'
    # path_test_data = '../data/task_data/ACP/tsv/ACP2_main_test.tsv'
    # path_train_data = '../data/task_data/ACP/tsv/ACP2_alternate_train.tsv'
    # path_test_data = '../data/task_data/ACP/tsv/ACP2_alternate_test.tsv'
    # path_train_data = '../data/task_data/ACP/tsv/ACPred-Fuse_ACP_Train500.tsv'
    # path_test_data = '../data/task_data/ACP/tsv/ACPred-Fuse_ACP_Test2710.tsv'
    # path_train_data = '../data/task_data/ACP/tsv/ACP_FL_train_500.tsv'
    # path_test_data = '../data/task_data/ACP/tsv/ACP_FL_test_164.tsv'
...
def load_config():
    ...
    if model_name == 'ACPred_LAF_Basic' or model_name == 'ACPred_LAF_MSE':
